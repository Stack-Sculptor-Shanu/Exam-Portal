...
const Landingpage = () => {
  ...
  <button className="mt-3 px-3 py-3 bg-white text-blue-600 font-semibold rounded-md shadow-md hover:bg-gray-200">
    <Link className="mt-3 px-7 py-3" to="/login">Get started</Link>
  </button>
</section>
  ...
  <div className="grid md:grid-cols-3 gap-8 mt-10 text-center">
    <div className="p-6 bg-white shadow-md rounded-md border border-gray-200 hover:shadow-xl hover:-translate-y-2 hover:bg-blue-100 hover:text-blue-600 hover:border-blue-500 transition-all duration-300 ease-in-out">
      ...
      <p className="mt-2 text-gray-600">Jooin the live exam to test yours skills in real-time with instant results and feedback .</p>
    </div>
    <div className="p-6 bg-white shadow-md rounded-md border border-gray-200 hover:shadow-xl hover:-translate-y-2 hover:bg-blue-100 hover:text-blue-600 hover:border-blue-500 transition-all duration-300 ease-in-out">
      <h3 className="text-xl font-semibold">Your Results</h3>
      <p className="mt-2 text-gray-600">View your exam results and track your progress with detailed insights and scores .</p>
    </div>
    <div className="p-6 bg-white shadow-md rounded-md border border-gray-200 hover:shadow-xl hover:-translate-y-2 hover:bg-blue-100 hover:text-blue-600 hover:border-blue-500 transition-all duration-300 ease-in-out">
      <h3 className="text-xl font-semibold">
